            ...
            <div class="card-body">
                ...
                <div class="table-responsive m-t-40">
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                        ...
                        <tbody>
                            @if(!empty($tecConcentraciones))
                            @foreach($tecConcentraciones as $tecnicas)
                                <tr>
                                    ...
                                    <a href="{{ route('editar_tec_concentracion', $tecnicas->id) }}" class="btn btn-warning mdi mdi-pencil-box-outline" title="Actualizar"></a>
                                    @if($tecnicas->estadoTEC==true)
                                        <a href="{{ route('estado_tconcentracion', $tecnicas->id) }}" class="btn btn-success  mdi mdi-arrow-up-bold-circle" title="Habilitado"></a>
                                    @elseif($tecnicas->estadoTEC==false)    
                                        <a href="{{ route('estado_tcadena', $tecnicas->id) }}" class="btn btn-danger mdi mdi-arrow-down-bold-circle" title="Deshabilitado"></a>
                                    @endif
                                    </td>
